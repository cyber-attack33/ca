...
def Main():
	...
	print("[\033[1;37m02\33[1;92m][\033[1;93mB\33[1;92m] CONTACT ADMIN")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/Remember.This.Name.A6Y1N');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801876280121');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	print(logo)
	print(50*'_')
	print(' [1] CONTACT WHATSAPP ')
	print(' [2] FOLLOW MY FB ACCOUNT ')
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/cyber-attack33');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mCA-33😌\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    AYAN=requests.get("https://github.com/cyber-attack33/approval/blob/main/AYAAN.txt").text
    if id in AYAN:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.H.A ROBOT and my boss is ALBERT AYAN.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/+8801876280121")
        superuser()        
